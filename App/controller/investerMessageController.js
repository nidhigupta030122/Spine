const InvesterMessagesModels = require("../models/investerMessageModel");
const InvesterAcceptRequestModel=require("../models/investerRequestAcceptModel")


module.exports.getMessages = async (req, res, next) => {
  try {
    const { from, to } = req.body;
    const messages = await InvesterMessagesModels.find({
      users: {
        $all: [from, to],
      },
      sender:from,
...
//     const data = await InvesterMessagesModels.create({
...
module.exports.deleteMessage = async (req, res, next) => {
  try {
    ...
    const result = await InvesterMessagesModels.deleteOne({ _id: messageId });
...
module.exports.getConnectedUsers = async (req, res, next) => {
  try {
    ...
    const connectedUsers = await InvesterAcceptRequestModel.aggregate([
